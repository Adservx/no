...
export const HorizontalPDFContactSheet = ({ config }) => {
    ...
    `;
        ...
        const progressBar = processingNotification.querySelector('.notification-progress-bar');
            ...
            for (let sheetIndex = 0; sheetIndex < totalSheets; sheetIndex++) {
                ...
                for (let i = 0; i < featherCount; i++) {
                    ...
                    for (let j = 0; j < barbCount; j++) {
                        ...
                        if (Math.abs(barbY - eyeY) < eyeRadius * 0.8)
                            continue;
                        ...
                        ctx.beginPath();
                        ctx.moveTo(0, barbY);
                        ctx.bezierCurveTo(barbLength / 3, barbY + stemLength / 30, barbLength / 2, barbY + stemLength / 20, barbLength, barbY);
                ...
                for (let i = 0; i < 2; i++) {
                    ...
                    try {
                        ...
                        const scale = Math.min(thumbWidth / viewport.width, finalThumbHeight / viewport.height);
